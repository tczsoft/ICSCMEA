...
function Editorial() {
    const highlights = [
        {
            title: "Smart Computational Techniques",
            description: "Advanced algorithms, optimization methods, and intelligent computing models."
        },
        {
            title: "Data-Driven Approaches",
            description: "Machine learning, big data analytics, and predictive modeling for real-world applications."
        },
        {
            title: "Emerging Applications",
            description: "Next-generation technologies in healthcare, robotics, finance, and smart cities."
        },
        {
            title: "Artificial Intelligence & Machine Learning",
            description: "Deep learning, reinforcement learning, and neural network advancements."
        },
        {
            title: "Cloud Computing & Edge Computing",
            description: "Scalable, distributed systems and edge intelligence for faster processing."
        },
        {
            title: "Internet of Things (IoT)",
            description: "Connected devices, smart sensors, and real-time monitoring systems."
        },
        {
            title: "Cybersecurity & Data Privacy",
            description: "Security models, encryption techniques, and privacy-preserving computation."
        },
        {
            title: "Interdisciplinary Innovations",
            description: "Integration of computing with engineering, science, and social applications."
        },
        {
            title: "High-Performance & Quantum Computing",
            description: "Supercomputing, quantum algorithms, and next-gen computational paradigms."
        },
        {
            title: "Sustainable & Green Computing",
            description: "Energy-efficient computational solutions for environmental sustainability."
        },
        {
            title: "Human-Computer Interaction (HCI)",
            description: "User experience design, virtual reality, and augmented reality interfaces."
        },
        {
            title: "Blockchain & Decentralized Applications",
            description: "Distributed ledger technologies, smart contracts, and secure decentralized systems."
        }
    ];
    return (
        <>
                ...
                <section className="lg:pt-0 pt-16">
                    <section className="max-w-[90rem] relative  mx-auto lg:px-5">
                        <div className="lg:p-20 p-10 bg-[#4AF8BA] w-fit rounded-b-full absolute -top-5 rounded-tr-4xl xl:block hidden">
                            <p className="text-center w-fit rounded-full font-semibold 2xl:text-3xl text-lg">Tracks</p>
                    ...
                    <div className="md:py-12 py-6 px-6">
                        <div className="max-w-[90rem] mx-auto text-center">
                            <div className='flex items-center gap-2 justify-center md:mb-10 mb-5'>
                                ...
                                <h2 className="md:text-2xl text-xl font-semibold ">Conference Tracks</h2>
                            </div>
