    ...
    return (
        <>
            <section className='bg-white/96'>
                ...
                <Common heading="About" path="About" paths="/about" content="The International Conference on Smart Computational Methods and Emerging Applications is a prestigious global forum designed to advance the frontiers of intelligent computational technologies and their real-world implementations. Set against the backdrop of rapid technological evolution, this conference offers a vital platform for scholars, engineers, scientists, technocrats, and industry professionals to share their pioneering ideas, research outcomes, and experiences." />
                <section>
