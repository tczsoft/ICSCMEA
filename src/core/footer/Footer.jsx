          ...
          <div className="max-w-[92rem] mx-auto px-5 lg:py-10 py-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center md:text-left mx-auto">
                ...
                <ul className="space-y-1 text-sm">
                  <li>Email: <a href="mailto:info.iciscm@gmail.com" className="underline">info.icscmea@gmail.com</a></li>
                  <li>Location: Taipei, Taiwan</li>
                </ul>
              </div>
            </div>
            <div className="border-t border-white/20 mt-8 pt-4 text-center text-sm text-gray-200">
              © {new Date().getFullYear()} <Link to='/'>ICSCMEA.</Link> All rights reserved.
            </div>
          </div>
        </div>
      </footer>
