...
function Submission() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const mailPromise = fetch('https://etcse-conference.org/api/send_mail.php', {
                method: 'POST',
                body: formDataToSend,
            });
                    ...
                    <div className="w-full lg:w-2/3 bg-white shadow-lg rounded-lg p-8 order-2 lg:order-1">
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                <select id="Paper_Track" name="Paper_Track" value={formData.Paper_Track} onChange={handleFileInputChange} className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-green-600 focus:border-green-600 focus:outline-none" required>
                                    <option value="">Select Paper Track</option>
