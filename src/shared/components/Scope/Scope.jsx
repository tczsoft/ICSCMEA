...
function Scope() {
    const highlights = [
        ...
        },
        {
            ...
            description: "Bring together researchers, industry experts, and academicians from around the globe.",
        },
        {
            title: "Bridge Research and Practice",
            description: "Translate theoretical advancements into real-world applications.",
        },
        {
            title: "Address Global Challenges",
            description: "Inspire solutions that tackle societal, industrial, and environmental issues.",
        },
        {
            title: "Empower Future Leaders",
            description: "Provide a platform for young researchers and students to showcase their work.",
        },
        {
